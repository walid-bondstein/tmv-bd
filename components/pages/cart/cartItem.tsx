  ...
  return (
    <div className="component-container mx-auto space-y-4 my-4">
      ...
      >
        ...
        <h2 className="md:text-2xl text-lg  md:font-bold font-medium text-[#202939]">
          Cart details
        </h2>
      </div>
          ...
          <div className="space-y-5">
            <div className="border space-y-4 border-gray-200 md:py-8 py-0 md:px-0 px-2 rounded-lg">
              ...
              <div className=" md:grid hidden">
                {items.map((item, key) => (
                  <div key={key} className="grid grid-cols-12 gap-2 px-7 my-2">
                    <div className="lg:col-span-6 col-span-12 flex justify-start items-center gap-3 lg:border-r border-r-0">
                      <div
                        onClick={() =>
                          removeFromCart(
                            item.id,
                            item.subscriptionDurationMonths
                          )
                        }
                        className="w-10 h-10 rounded-full bg-[#F0F5FB] shrink-0 flex justify-center items-center cursor-pointer"
                      >
                        <X />
                      </div>
                    ...
                    <div className="lg:col-span-1 col-span-3 flex lg:justify-start justify-center items-center text-[#727B8C]">
                      <p>
                        ...
                        {toIndianNumberFormat(Math.round(item.priceWithoutDiscount))}/-BDT
                      </p>
                    </div>
                    ...
                    <div className="lg:col-span-2 col-span-3 flex lg:justify-start justify-center items-center text-[#727B8C]">
                      <p>
                        ...
                        {toIndianNumberFormat(Math.round((item.priceWithoutDiscount + item.subscriptionPrice) *
                          item.quantity))}{" "}
                        BDT
                      </p>
                    </div>
              ...
              <div className="grid md:hidden">
                {items.map((item, key) => (
                  <div key={key} className="my-2 border-b space-y-4">
                    ...
                    <div className="space-y-2">
                      <p className="text-[26px] leading-[26px] font-medium text-[#211E1F]">
                        {item.name}
                      </p>
            ...
            {coupon ? (
                ...
                <div className="border border-gray-200 md:px-7 px-2 md:py-8 py-3  mb-4 rounded-lg flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center gap-4">
                    ...
                    <Button
                      ...
                      className="bg-primary rounded-lg tmv-shadow submit cursor-pointer text-[clamp(14px,4.0625vw,16px)]"
                    >
                      <X />
                    </Button>
                  </div>
              ...
              <>
                ...
                {showCoupon && (
                  <div className="border border-gray-200 md:px-7 px-2 md:py-8 py-3 mb-4 rounded-lg">
                    {/* Coupon Code */}
        ...
        <div className="xl:col-span-5 col-span-12">
          <div className="border md:px-7 px-2 md:py-8 py-3 rounded-lg space-y-4">
            ...
            <div className="grid grid-cols-2 gap-y-4">
              ...
              <p className="text-sm md:text-lg font-semibold text-right">{toIndianNumberFormat(Math.round(totalVat)) ?? 0}/- BDT</p>
              <p className="text-sm font-medium md:text-lg text-[#727B8C]">
                Subtotal Amount
              </p>
              <p className="text-sm md:text-lg font-semibold text-right">
                {toIndianNumberFormat(Math.round(subtotal))}/- BDT
              </p>
              {coupon ? <>
                <p className="text-sm font-medium md:text-lg text-[#727B8C]">
                  Coupon Discount
                ...
                <p className="text-sm md:text-lg font-semibold text-right">
                  {toIndianNumberFormat(Math.round(discount))}/- BDT
                </p>
              </> : <></>}
            </div>
            <hr />
            <div className="grid grid-cols-2">
              ...
              <p className="text-sm md:text-lg font-semibold text-right">
                {toIndianNumberFormat(Math.round(total))}/- BDT
              </p>
            </div>
