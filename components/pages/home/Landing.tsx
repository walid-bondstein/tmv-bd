...
export default function Landing() {
    return (
        <section
            className={`lg:bg-[url("/images/group.png")] lg:bg-no-repeat lg:bg-[length:50%_100%] lg:bg-[position:100%_0%] bg-secondary section-padding-y min-h-[100vh] flex flex-col`}
