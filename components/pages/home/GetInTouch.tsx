        ...
        ">
                <div className='flex-1 space-y-5'>
                    <div className="max-w-md">
                        <h2 className="font-semibold text-black text-[clamp(2rem,2.8124vw,3.375rem)] text-left">Get In Touch</h2>
                        <p className="text-[clamp(0.7rem,2.8124vw,1rem)] text-[#777F92] text-left">Have questions? Our team is here to help you with all your vehicle tracking needs. Reach out to us today!</p>
                    </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex gap-3">
                                <Select defaultValue="+880" name="countryCode">
                                    <SelectTrigger size="" className="w-24 bg-white/20 border-gray-200 text-gray-900 focus:ring-yellow-400">
