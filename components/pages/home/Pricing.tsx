...
export default function Pricing({ products }: {
    ...
    return (
        <div className="component-container mx-auto lg:space-y-16 md:space-y-8 space-y-2" id="pricing"  >
            ...
            <section className="lg:grid hidden grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-6 my-10">
                {
            ...
            <section className="lg:hidden block overflow-x-auto">
