...
const cards = [
  {
    ...
    title: (
      <p>
        Why Vehicle Tracking <br /> Saves Money
      </p>
    ),
  ...
  },
  {
    ...
    title: (
      <p>
        Fleet Efficiency Made <br /> Simple with GPS
      </p>
    ),
  ...
  },
  {
    ...
    title: (
      <p>
        The Role of Tracking in <br /> Preventing Accidents
      </p>
    ),
          ...
          >
            <div>
              <motion.h3
                ...
                className="lg:text-3xl line-clamp-2 text-left md:text-2xl text-xl"
              >
                {item.title}
              </motion.h3>
              {index === hovered && (
                ...
                >
                  <p className="text-sm font-light text-left md:inline hidden">
                    {item.sub}
                  </p>
                  <Link
                    href={item.learnMore}
