...
export const PricingCard: React.FC<Props> = ({ product }) => {
    ...
    return (
        <div className="max-w-[280px] min-w-[250px] md:max-w-96 flex flex-col space-y-3 justify-between bg-[#F6F5EE] relative rounded-xl transition hover:shadow-md w-full overflow-hidden group/card flex-1">
            {/* Subscription Label */}
            {/* {monthlySubscription ? (
