...
export const PricingCard: React.FC<Props> = ({ product }) => {
    ...
    return (
        <div className="max-w-[280px] min-w-[280px] md:max-w-[360px] flex flex-col space-y-3 justify-between bg-[#F6F5EE] relative rounded-xl transition hover:shadow-md w-full overflow-hidden group/card flex-1">
            ...
            <div className={`whitespace-nowrap ml-auto text-ellipsis text-sm px-[18px] py-[11px] bg-white group-hover/card:bg-primary text-left font-semibold rounded-bl-4xl text-black transition-all duration-300 ${Number(discounted) === 0 ? "opacity-0" : "opacity-100"}`}>
