...
const steps: Step[] = [
    {
        ...
        description: "Get your tracking device delivered and installed in your vehicle by our experts for seamless setup.",
    },
    {
        icon: <Crown className="h-6 w-6" />,
        title: "Activate Subscription",
        description: "Choose a plan that fits your needs and activate your subscription instantly to start tracking.",
    },
    {
        icon: <Smartphone className="h-6 w-6" />,
        title: "Track on App/Web",
        description: "Monitor your vehicle's location and status anytime, anywhere through our mobile app or web platform.",
    },
]
            ...
            <div className="container lg:px-4 md:px-6 px-0 mx-auto w-full">
                ...
                <div className="hidden lg:grid lg:grid-cols-[300px_1fr] lg:gap-12 lg:items-start">
                    ...
                    <div className="space-y-6">
                        <div className="max-w-xs">
                            <h2 className="text-3xl text-title tracking-tight text-balance">How <br /> It Works</h2>
                            <p className="mt-2 text-muted-foreground text-subtitle text-pretty">Quick trust-building line BTRC <br /> Approved</p>
                        </div>
                        <Button className="bg-[#F3F5F8]" variant="outline" size="lg">
                            See Plans & Pricing
                        </Button>
                    </div>
                ...
                <div className="lg:hidden space-y-4 mx-auto">
                    ...
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-muted-foreground text-subtitle text-pretty">Quick trust-building line BTRC Approved</p>
                    </div>
                        ...
                        {steps.map((step, index) => (
                            <div key={index} className="space-y-3 rounded-lg bg-[#F3F5F8] p-3">
                                ...
                                <div className="flex-1 space-y-1">
                                    <h3 className="font-semibold text-base text-balance">{step.title}</h3>
                                    <p className="text-sm text-muted-foreground text-pretty leading-relaxed">{step.description}</p>
                                </div>
                            </div>
                        ))}
