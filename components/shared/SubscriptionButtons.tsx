"use client"
import { ProductSubscription } from '@/app/page';
    ...
    return (
        <div className="grid grid-cols-2 gap-2">
            {sixMonthSubscription ? <button
                ...
                className={`${sixMonthSubscription?.product_subscription_id === selected?.product_subscription_id ? "bg-submit" : ""} w-full shrink-0 cursor-pointer group relative px-2 py-2 rounded-xl font-semibold bg-white text-black hover:bg-white/90 transition-all duration-200 border border-white hover:border-primary/80 flex items-center justify-between`}
            >
                <div className="text-left">
                    <p className="text-[14px] font-semibold whitespace-nowrap text-primary-foreground tracking-wider">6 Month</p>
                    <p className="text-[10px] font-normal text-primary-foreground whitespace-nowrap">+{toIndianNumberFormat(Number(sixMonthSubscription?.final_amount))} BDT</p>
                </div>
            ...
            <button
                ...
                className={`${twelveMonthSubscription?.product_subscription_id === selected?.product_subscription_id ? "bg-submit" : ""} w-full shrink-0 cursor-pointer group relative px-2 py-2 rounded-xl font-semibold bg-white text-black hover:bg-white/90 transition-all duration-200 border border-white hover:border-primary/80 flex items-center justify-between`}
            >
                <div className="text-left">
                    <p className="text-[14px] font-semibold whitespace-nowrap text-primary-foreground tracking-wider">12 Month</p>
                    <p className="text-[10px] font-normal text-primary-foreground whitespace-nowrap">+{toIndianNumberFormat(Number(twelveMonthSubscription?.final_amount))} BDT</p>
                </div>
